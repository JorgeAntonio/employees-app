  ...
  const jsonString = '''
{
  ...
  "data": {
    ...
    "employee": {
      ...
      "shift": {
        "name": "Tarde",
        "startTime": "Mon Aug 25 2025 19:00:00 GMT+0000 (Coordinated Universal Time)",
        "endTime": "Tue Aug 26 2025 04:00:00 GMT+0000 (Coordinated Universal Time)"
      }
    },
    "statistics": {
      "totalDays": 1,
...
''';
  ...
  try {
    ...
    print('Start Time: ${model.data?.employee?.shift?.startTime}');
    print('End Time: ${model.data?.employee?.shift?.endTime}');
